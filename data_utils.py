...
def prepare_batch_predict_data(keyword, previous=[], prev=True, rev=False, align=False):
    ...
    for sentence in previous:
        sentence_ints = process_sentence(sentence, rev=rev, pad_len=5 if align else None)
        ...
        while not stop:
            ...
            for i in range(batch_size):
                ...
                if not line:
                    ...
                    current_sentence_ints = process_sentence(current_sentence, rev=rev, pad_len=5 if align else None)
